...
description: Develops, debugs, and verifies DSRC/RSU/OBU features in WJ_DSRCProtocolTest_Desk_Net_20260920 (WinForms, DesktopComm, lane trade). Use for new features, UI, DLL/serial, frame parsing, and pass/fail logic. Do not use for C++/MFC migration audits.
---
