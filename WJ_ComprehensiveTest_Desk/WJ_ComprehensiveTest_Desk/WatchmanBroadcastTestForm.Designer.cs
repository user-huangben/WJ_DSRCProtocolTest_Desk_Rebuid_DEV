...
{
    partial class WatchmanBroadcastTestForm
    {
        ...
        /// <summary>
        /// 初始化守望者播报测试独立大框的标题、测试树、操作区和测试信息区。
        /// </summary>
        private void InitializeComponent()
        {
            ...
            {
                new TreeNode("基础播报", new TreeNode[]
                {
                    new TreeNode("设备状态播报"),
                    new TreeNode("交易完成播报")
                }),
                new TreeNode("金额播报", new TreeNode[]
                {
                    new TreeNode("小额播报"),
                    new TreeNode("整额播报"),
                    new TreeNode("边界金额播报")
                }),
                new TreeNode("异常播报", new TreeNode[]
                {
                    new TreeNode("余额不足播报"),
                    new TreeNode("交易失败播报")
                }),
                new TreeNode("组合流程", new TreeNode[]
                {
                    new TreeNode("交易后播报")
                })
            });
            ...
            richTextBoxInformation.Text = "守望者播报测试框架已加载。请选择叶子用例后执行；具体播报协议处理器待按原上位机逐项移植。";
            richTextBoxInformation.TextChanged += new System.EventHandler(richTextBoxInformation_TextChanged);
            // 
            // WatchmanBroadcastTestForm
            // 
            ...
            Name = "WatchmanBroadcastTestForm";
